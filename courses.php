			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<b>Liste de Classe et Scolarité</b>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-outline-primary edit_course" type="button" data-id="<?php echo $row['id'] ?>" >Modifier</button>
										<button class="btn btn-sm btn-outline-danger delete_course" type="button" data-id="<?php echo $row['id'] ?>">Supprimer</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
	...
	$('.edit_course').click(function(){
		uni_modal("Modifier Classe et Scolarité","manage_course.php?id="+$(this).attr('data-id'),'large')
		
	})
	$('.delete_course').click(function(){
		_conf("Etes vous sûr de supprimer ?","delete_course",[$(this).attr('data-id')])
	})
